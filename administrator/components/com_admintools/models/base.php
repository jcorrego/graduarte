...
abstract class AdmintoolsModelBase extends JModel
{
	...
	public function __construct($config = array())
	{
		...
		$limitstart = $app->getUserStateFromRequest(JRequest::getCmd('option','com_admintools').$this->getName().'limitstart','limitstart',0);
