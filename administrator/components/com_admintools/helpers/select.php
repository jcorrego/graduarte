...
class AdmintoolsHelperSelect
{
	...
	public static function reasons($selected = null, $id='reason', $attribs=array())
	{
		$reasons = array('other','adminpw','ipwl','ipbl','sqlishield','antispam',
			...
			'geoblock','rfishield','dfishield','uploadshield','xssshield','loginfailure');
		$options = array();
	...
	{
		$rawperms = array(0400,0440,0444,0600,0640,0644,0664,0700,0740,0744,0750,0754,0755,0775,0777);
