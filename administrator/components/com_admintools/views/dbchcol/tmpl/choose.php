...
<form action="index.php" name="adminForm" id="adminForm">
	...
	<input type="submit" value="<?php echo JText::_('ATOOLS_LBL_DBCHCOLAPPLY'); ?>" />
	&nbsp;&nbsp;<a href="index.php?option=com_admintools"><?php echo JText::_((ADMINTOOLS_JVERSION == '15') ? 'Back' : 'JTOOLBAR_BACK') ?></a>
</form>