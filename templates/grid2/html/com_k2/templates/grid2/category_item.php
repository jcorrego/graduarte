...
<div class="sectitemTitle">
	...
	<div class="titleWrapper <?php if (!($this->params->get('catItemDateCreated'))) : ?>full<?php endif; ?>">	
  ...
  <?php if ($this->item->params->get('catItemHits') || ($this->item->params->get('catItemAttachments') && count($this->item->attachments)) || ($this->item->params->get('catItemTags') && count($this->item->tags))) : ?>
  <div class="catItemLinks">

	  <?php if($this->item->params->get('catItemAttachments') && count($this->item->attachments)): ?>
	  <!-- Item attachments -->
	  <div class="catItemAttachmentsBlock">
		  <h3><?php echo JText::_("Download attachments:"); ?></h3>
