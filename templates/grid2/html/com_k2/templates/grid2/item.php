...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader  <?php if($this->item->params->get('itemFeaturedNotice') && $this->item->featured): ?>featured<?php endif; ?>">
	<div class="k2Meta">
		<div class="itemTitle">
		...
		<?php endif; ?>
	<div class="titleWrapper <?php if (!($this->params->get('itemDateCreated'))) : ?>full<?php endif; ?> ">
	  <?php if($this->item->params->get('itemTitle')): ?>
	  <!-- Item title -->
	  <h2 class="itemTitle <?php if($this->item->params->get('itemDateCreated')): ?>dateheading<?php endif; ?> <?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemAuthor')): ?>noborder<?php endif; ?>">
	  ...
	  <?php 
	  if($this->item->params->get('itemPrintButton') ||
	  ...
	  <?php if($this->item->params->get('itemPrintButton')): ?>
		...
		<?php endif; ?>
			...
			<!-- Item category name -->
			<div class="itemCategory <?php if($this->item->params->get('itemDateCreated')): ?>dateheading<?php endif; ?>">
			...
			<!-- Item Author -->
			<span class="itemAuthor <?php if($this->item->params->get('itemDateCreated')): ?>dateheading<?php endif; ?>">
...
<?php if($this->item->params->get('itemShareLinks') ||$this->item->params->get('itemNavigation') && !JRequest::getCmd('print') && (isset($this->item->nextLink) || isset($this->item->previousLink))): ?>
	<div class="itemLinksNavigation">
