...
<div class="catItemView">
	...
	<div class="titleWrapper <?php if (!($this->params->get('latestItemDateCreated'))) : ?>full<?php endif; ?>">
  ...
  <?php if($this->item->params->get('latestItemCategory')): ?>
		<!-- Item category name -->
		<div class="userItemCategory <?php if($this->item->params->get('latestItemDateCreated')): ?>dateheading<?php endif; ?>">
