...
<?php if ($this->item->params->get('show_create_date')) : ?>
	...
	<?php endif; ?>
	<div class="titleWrapper <?php if (!($this->params->get('show_create_date'))) : ?>full<?php endif; ?> ">
<?php if ($this->item->params->get('show_title')) : ?>
<h2 class="<?php if ($this->params->get('show_create_date')) : ?>dateheading <?php endif; ?> <?php if ($this->item->params->get('show_author') || $this->item->params->get('show_create_date')  || ($this->item->params->get('show_section') && $this->item->sectionid) || $this->item->params->get('show_category') && $this->item->catid) : ?>noborder<?php endif; ?> contentheading<?php echo $this->escape($this->item->params->get('pageclass_sfx')); ?>">
...
<div class="buttons <?php if ($this->item->params->get('show_author') || $this->item->params->get('show_create_date')  || ($this->item->params->get('show_section') && $this->item->sectionid) || $this->item->params->get('show_category') && $this->item->catid) : ?>noborder<?php endif; ?>">
...
<?php if ($this->item->params->get('show_author') || $this->item->params->get('show_create_date')  || ($this->item->params->get('show_section') && $this->item->sectionid) || $this->item->params->get('show_category') && $this->item->catid) : ?>
...
<div class="jbSectCat <?php if ($this->params->get('show_create_date')) : ?>dateheading<?php endif; ?>">
