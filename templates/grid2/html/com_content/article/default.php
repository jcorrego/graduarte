...
<div class="itemTitle">
	...
	<?php if (($this->params->get('show_section') && $this->article->sectionid) || ($this->params->get('show_category') && $this->article->catid) || ($this->params->get('show_author') && ($this->article->author != "")) || ($this->params->get('show_create_date'))) : ?>
...
<div class="jbAuthorDate">
			...
			<!-- Author -->
			<div class="jbAuthor <?php if ($this->params->get('show_create_date')) : ?>dateheading<?php endif; ?>">
			...
			<span class="buttons <?php if (($this->params->get('show_section') && $this->article->sectionid) || ($this->params->get('show_category') && $this->article->catid) || ($this->params->get('show_author') && ($this->article->author != "")) || ($this->params->get('show_create_date'))) : ?>noborder<?php endif; ?>">
		<?php if ($this->print) :
