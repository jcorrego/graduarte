			...
			<div align="center">
				<table width="800" border="0" cellspacing="0" cellpadding="0" >
					...
					<tr>
						...
						<table width="800" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="94" valign="top" style="text-align: center; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; color: #000"><br />
...
<table border="0" width="100%">
	<tr>
		<td height="4"></td>
								...
								<img border="0" src="logovertical.png" ></td>
								<td  width="10">&nbsp;
							...
							<tr>
								...
								<p>&nbsp;<p>&nbsp;</td>
								<td style="text-align: center; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; color: #000" colspan="2">
							  <jdoc:include type="modules" name="bottom" /></td>
							</tr>
							<tr>
								<td  style="text-align: center; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; color: #000">
							</td>
							...
							<tr>
								<td height="25" colspan="3" bgcolor="#E9E9E9" style="text-align: center; font-family: Tahoma, Geneva, sans-serif; font-size: 16px; color: #000">
								  <font color="#333333">CRA 67 No. 42 - 27&nbsp;&nbsp; 
